...
df.to_csv(file_name)
index_CT = ['ub_039','b_039','ub_068','ub_077','b_097','b_117']
d = {
    "FWHM_org": pd.Series(CT_FWHMs_org, index=index_CT),
    'FWHM_fit': pd.Series(CT_FWHMs_fit, index=index_CT),
...
d = {
    "FDG_FWHM_fit": pd.Series(FDG_FWHMs_fit, index=namesFDG+names_FDG_PET),
    "FDG_FWHM_org": pd.Series(FDG_FWHMs_org, index=namesFDG+names_FDG_PET),
    "noise mean FDG": pd.Series(noise_FDG_mean,index=namesFDG+names_FDG_PET),
    "noise std FDG": pd.Series(noise_FDG_std,index=namesFDG+names_FDG_PET),
    "GA_FWHM_fit": pd.Series(GA_FWHMs_fit, index=namesFDG+names_FDG_PET),
    "GA_FWHM_org": pd.Series(GA_FWHMs_org, index=namesFDG+names_FDG_PET),
    "noise mean GA": pd.Series(noise_GA_mean,index=namesFDG+names_FDG_PET),
    "noise std GA": pd.Series(noise_GA_std,index=namesFDG+names_FDG_PET),
}
